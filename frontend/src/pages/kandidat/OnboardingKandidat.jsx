...
const OnboardingKandidat = () => {
  ...
  const handleDownloadLoa = async (url, e) => {
    e.preventDefault();
    try {
      if (!onboarding.is_loa_downloaded) {
        ...
        <div className="mt-8 relative">
          ...
          <div className="flex justify-between">
            {STEPS.map((step, idx) => {
              ...
              const isActive = effectiveStatus === step.id;
              const isPast = currentStepIndex > idx || (effectiveStatus === 'COMPLETED' && idx === STEPS.length - 1);
              return (
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        {(onboarding.status === 'DOCUMENT_VERIFICATION' || onboarding.status === 'DOCUMENT_REVISION') && (
          <div>
            ...
            {effectiveStatus === 'DOCUMENT_REVISION' && (
        ...
        {(effectiveStatus === 'PLACEMENT_ASSIGNED' || effectiveStatus === 'ACCOUNT_CREATED') && (
          <div className="text-center py-8">
        ...
        {effectiveStatus === 'CHECKLIST_IN_PROGRESS' && (
          <div className="text-center py-8">
        ...
        {(effectiveStatus === 'ORIENTATION_SCHEDULED' || effectiveStatus === 'COMPLETED') && (
          <div className="text-center py-8">
