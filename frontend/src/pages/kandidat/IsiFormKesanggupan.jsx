...
const IsiFormKesanggupan = () => {
  ...
  const fetchActiveFormAndPendaftaran = async () => {
    try {
      ...
      const resLamaran = await axios.get(`${API_URL}/kandidat/applications`, {
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="pt-6 border-t border-gray-200 flex justify-end">
              <button
                type="submit"
                disabled={submitting}
                className="bg-gradient-to-r from-blue-600 to-cyan-400 hover:from-blue-700 hover:to-cyan-500 text-white px-8 py-3 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all flex items-center disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {submitting ? 'Mengirim...' : (
                  <>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm transition-all duration-200">
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6 transform transition-all scale-100 opacity-100">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-800">Konfirmasi Jawaban</h3>
                <p className="text-slate-500 text-sm mt-1">Apakah Anda yakin dengan jawaban ini? Jawaban tidak dapat diubah setelah dikirim.</p>
              </div>
            </div>
            <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-slate-100">
              ...
              <button 
                ...
                className="px-5 py-2.5 rounded-xl font-medium text-white bg-gradient-to-r from-blue-600 to-cyan-400 hover:from-blue-700 hover:to-cyan-500 shadow-md transition-all flex items-center gap-2"
                type="button"
              >
                Ya, Kirim
              </button>
