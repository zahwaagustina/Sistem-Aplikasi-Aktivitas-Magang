    ...
    <div className="relative min-h-screen bg-gradient-to-br from-blue-100 via-blue-50 to-blue-200 flex flex-col items-center justify-center p-4 font-sans">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-extrabold text-slate-900 mb-3 tracking-tight">Lupa Password</h1>
          <p className="text-slate-500 text-lg">Masukkan email Anda untuk menerima link reset password.</p>
        </div>
        ...
        <div className="bg-white/30 backdrop-blur-xl border border-white/50 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] rounded-3xl p-8 sm:p-10">
          ...
          <div className="mt-8 text-center text-slate-600">
            Ingat password Anda?{' '}
            <Link to="/login" className="text-[#004aad] font-bold hover:underline">
              Kembali ke Login
            </Link>
          </div>
        </div>
